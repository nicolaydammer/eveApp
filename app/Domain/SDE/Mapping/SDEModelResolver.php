...
class SDEModelResolver
{
    protected array $models = [
        ...
        'corporationRoleGroups' => 'CorporationRoleGroup',
        'corporationRoles' => 'CorporationRole',
        'expertSystems' => 'ExpertSystem',
        'fighterAbilities' => 'FighterAbility',
        'fighterAbilitiesByType' => 'FighterAbilityByType',
        'industryActivities' => 'IndustryActivity',
        'industryAssemblyLines' => 'IndustryAssemblyLine',
        'industryInstallationTypes' => 'IndustryInstallationType',
        'industryModifierSources' => 'IndustryModifierSource',
        'industryTargetFilters' => 'IndustryTargetFilter',
        'linkWithShip' => 'LinkWithShip',
        'metenoxMoonDrill' => 'MetenoxMoonDrill',
        'notificationTypes' => 'NotificationType',
        'proximityTrap' => 'ProximityTrap',
        'schoolMap' => 'SchoolMap',
        'schools' => 'School',
        'skillPlans' => 'SkillPlan',
        'skinrSlotsToMaterials' => 'SkinrSlotsToMaterials',
        'stationStandingsRestrictions' => 'StationStandingsRestriction',
        'systemDbuffEmitters' => 'SystemDBuffEmitter',
        'systemWideEffects' => 'SystemWideEffect',
        'typeElements' => 'TypeElement',
        'graphicMaterialSets' => 'GraphicMaterialSet',
        'missions' => 'Mission',
        'shipTreeFactions' => 'ShipTreeFaction',
        'skinrComponentPointValues' => 'SkinrComponentPointValue',
        'skinrComponents' => 'SkinrComponent',
        'skinrSlotCategories' => 'SkinrSlotCategory',
        'skinrSlotNames' => 'SkinrSlotName',
        'skinrSlots' => 'SkinrSlot',
        'skinrTierThresholds' => 'SkinrTierThreshold',
        'accountingEntryTypes' => 'AccountingEntryType',
        'appliedProximityEffects' => 'AppliedProximityEffect',
        'epicArcs' => 'EpicArc',
        'militaryCampaignObjectives' => 'MilitaryCampaignObjective',
        'militaryCampaigns' => 'MilitaryCampaign',
        'shipTreeElements' => 'ShipTreeElement',
        'shipTreeGroups' => 'ShipTreeGroup',
        'skinrComponentCategories' => 'SkinrComponentCategory',
        'skinrComponentRarities' => 'SkinrComponentRarity',
        'skinrSlotConfigurations' => 'SkinrSlotConfiguration',
    ];
